<div>
	...
	var column = [
		...
		var setting = {nsTitle:"Async Grid Demo",type:"",renderInCachedMode:false,enableVirtualScroll:false,enableDataRefreshOnScrollEnd:false,dataRefreshfireDelay:100, 
			 		   enableFilter:true,enableAdvancedFilter:true,enablePagination:true,paginationType:"scroll",enableAsyncLoadPagination:true, 
			           ...
			           columnDraggable:true,pageSize:100,fetchRecordCallBack:"addRows",totalRecords:10000,rowHeight:30,leftFixedColumn:0,rightFixedColumn:0,
		...
		var nsGrid = null;
		var arrItems = [];
		window["loadAysncHandler"] = function ()
		{
