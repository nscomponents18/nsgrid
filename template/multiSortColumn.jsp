<div>
	...
	var column = [
		...
		var setting = {nsTitle:"Multi Column Sort Demo",type:"",enableMultiSort:true,multiColumnKey:"alt",enableFilter:true,enableAdvancedFilter:true,
		...
		var nsGrid = null;
		var arrItems = [];
		window["loadMultiSortColumnView"] = function ()
		{
			...
			//
			var setDataSource = function (from,to,index)
			{
				for(var count = from;count <= to;count++)
				{
					item = {id: count, hierarchy: 'Hierarchy ' + index, supervisor: "Supervisor " + count, country: 'UK', employees: "EmployeesEmployeesEmployees" + count, price: (10 * count), year: 1985 + count,checked:false};
					if((count % 2) === 0)
					{
						item["country"] = "US";
					}
			...
			setDataSource(0,49,1);
			setDataSource(50,99,2);
			setDataSource(100,149,3);
		...
		window["updatePricesSort"] = function()
		{
