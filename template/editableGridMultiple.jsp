<div>
	...
	var setting = {nsTitle:"Multiple Editable Grid Demo",enableEditable:true,
					...
					editorSetting:{stopEditingOnGridFocusOut:true,clickType:NSGrid.EDITOR_EDITING_DOUBLECLICK,enableMultipleEdit:true}};
	
	window["loadMultipleEditableGrid"] = function ()
	{
		arrItems = [];
		var item = {};
		var count = 0;
	...
	//# sourceURL=editableGridMultiple.js
	</script>
</div>