<div>
	...
	<!-- auto,manual -->
	<!-- stack,columnToggle -->
	<div id="dgDemo" style="width:1200px;">
	</div> 
	<br/>
	<br/>
	...
	<script>
		var column = [
		      		...
		      		{headerText:"Price",dataField:"price",toolTipField:"price",width:"200px",sortable:true,sortDescending:true,priority:5
			      					,showMenu:true,enableFilter:false},
		...
		var customScrollerSetting = {enableAnimation: true};
		var setting = {nsTitle:"Custom Scroll Demo",type:"",headerExtraRowCount:1,enableFilter:true,enableAdvancedFilter:true, 
				 	   rowKeyField:"id",totalRecords:600,enableCustomScrollBar:true,columnResizable:true,enableVirtualScroll:false,
			           columnDraggable:true,rowHeight:30,leftFixedColumn:0,rightFixedColumn:1,enableExport:true,heightOffset:250,theme:"White"
			           ,enableScrollBarTip: true,customScrollBarSetting: customScrollerSetting};
		var nsGrid = null;
		var arrItems = [];
		window["loadCustomScrollHandler"] = function ()
		{
		...
		window["fixedLeftColumn"] = function (event)
		{
			...
			var dgDemo = document.getElementById("dgDemo");
			dgDemo.innerHTML = "";
			window["loadCustomScrollHandler"]();
			nsGrid.fixFixedHeader();
		}
