<div>
	...
	var column = [
		...
		var setting = {nsTitle:"Pagination Demo",type:"",enablePagination:true,paginationType:"pages",enableFilter:true,enableAdvancedFilter:true,
					   paginationMode:"auto",pageSize:100,fetchRecordCallBack:"addRows",totalRecords:600,
					   enableMouseHover:true,enableMultipleSelection:true,
		...
		var nsGrid = null;
		var arrItems = [];
		window["loadPagination"] = function ()
		{
