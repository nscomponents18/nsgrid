<div>
	...
	var setting = {nsTitle:"Editable Row Grid Demo With Initiator",enableEditable:true,
					...
					editorSetting:{editType:NSGrid.EDITOR_EDITTYPE_ROW,clickType:NSGrid.EDITOR_EDITING_NOCLICK,enableMultipleEdit:true}};
	
	window["loadEditableRowGridWithInitiator"] = function ()
	{
		arrItems = [];
		var item = {};
		var count = 0;
               ...
               iCancel.addEventListener("click",function(event)
                   {
                       ...
                       nsGrid.updateItemInDataSource(item);
                       nsGrid.updateCellByKeyField(item["id"],dataField);
                       nsGrid.editStopByItem(item,null,true);
                   });
               ...
               iSave.addEventListener("click",function(event)
                   {
                   		...
                   		nsGrid.updateItemInDataSource(item);
                   	 	nsGrid.updateCellByKeyField(item["id"],dataField);
                   		nsGrid.editStopByItem(item,null,false);
                   });
	...
	//# sourceURL=editableRowGridWithInitiator.js
	</script>
</div>