<div>
	...
	var setting = {nsTitle:"Editable Grid Demo",enableEditable:true,
					...
					editorSetting:{stopEditingOnGridFocusOut:true,clickType:NSGrid.EDITOR_EDITING_DOUBLECLICK}};
	
	window["loadEditableGrid"] = function ()
	{
		arrItems = [];
		var item = {};
		var count = 0;
